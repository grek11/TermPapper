    ...
    public partial class frmRules : Form
    {
        ...
        private void btnAddRule_Click(object sender, EventArgs e)
        {
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Правило з таким ім'ям вже існує!");
                    return;
                }
                if (newRule == "")
                {
                    MessageBox.Show("Правило не може бути без ім'я!");
                    return;
                }
                // добавляем правило
        ...
        {
            if (MessageBox.Show("Підтвердження", "Дійсно видалити вивід цього правила?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        private void btnDeleteReason_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Спочатку необхідно обрати потрібний варіант");
                    return;
                }
        ...
        private void btnDeleteRule_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Спочатку необхідно обрати правило");
                return;
            }

            if (MessageBox.Show("Дійсно видалити правило?", "Підтвердження", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
